            ...
            <div class="card card-default">
                ...
                <form id="admin_display_settings_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.display_info_in_login_modal')}}</label><br />
                                <input type="radio" class="minimal" name="display_info_in_login_modal" value="yes" 
                                {{sel(setting('display_info_in_login_modal'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="display_info_in_login_modal" value="no"
                                {{sel(setting('display_info_in_login_modal'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>                        
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            <h2>{{__('message.css')}}</h2>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('message.front_site_css')}}</label>
                                <input type="hidden" name="front_site_css" id="editor_hidden_front" />
                                <textarea id="css_editor_front">{!! setting('front_site_css') !!}</textarea>                                
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('message.candidate_site_css')}}</label>
                                <input type="hidden" name="candidate_site_css" id="editor_hidden_candidate" />
                                <textarea id="css_editor_candidate">{!! setting('candidate_site_css') !!}</textarea>                                
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
