                ...
                <div class="box box-info">
                    ...
                    <form id="company_profile_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @php $thumb = companyThumb($profile['image']); @endphp
                                        <input type="file" class="form-control dropify" name="image" 
                                            data-default-file="{{$thumb['image']}}" />
                                    </div>
                                </div>
                                @if(companySession('type') == 'main')
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ __('message.logo') }}</label>
                                        @php $thumb = companyThumb($profile['logo'], true); @endphp
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary" id="company_profile_form_button">{{ __('message.save') }}</button>
                        </div>
                    </form>
                </div>
            </section>
