...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fas fa-cube"></i> {{ __('message.departments') }}<small></small></h1>
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fas fa-cube"></i> {{ __('message.departments') }}</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        @if(empAllowedTo('view_departments'))
