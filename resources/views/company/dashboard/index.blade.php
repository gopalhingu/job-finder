        ...
        <div class="row">
            <div class="col-md-2 col-sm-12">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="{{url('/')}}/company/jobs" class="small-box-footer">
            ...
            <div class="col-md-2 col-sm-12">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="{{url('/')}}/company/candidates" class="small-box-footer">
            ...
            <div class="col-md-2 col-sm-12">
                ...
                <div class="small-box bg-primary">
                    ...
                    <a href="{{url('/')}}/company/job-board" class="small-box-footer">
                    {{ __('message.more_info') }} <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-2 col-sm-12">
                ...
                <div class="small-box bg-maroon">
                    ...
                    <a href="{{url('/')}}/company/candidate-interviews" class="small-box-footer">
                    {{ __('message.more_info') }} <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
