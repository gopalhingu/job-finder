...
use App\Models\Company\Employer;
use App\Models\Company\Candidate;
use App\Models\Company\CandidateInterview;
...
class JobBoardController extends Controller
{
    ...
    public function index(Request $request, $job_id = '')
    {
        ...
        $data['jobs'] = view('company.job-board.job-list-items', compact('jobs'))->render();
        ...
        return view('company.job-board.index', $data);
    }
    ...
    public function candidatesList(Request $request, $job_id = '')
    {
        ...
        echo json_encode(array(
            ...
            'list' => view('company.job-board.candidate-list-items', compact('candidates'))->render(),
        ));
    }
