...
class DepartmentsController extends Controller
{
    ...
    public function listView()
    {
        ...
        return view('company.departments.list', $data);
    }
    ...
    public function createOrEdit($department_id = NULL)
    {
        ...
        echo view('company.departments.create-or-edit', compact('department'))->render();
    }
    ...
    public function save(Request $request)
    {
        ...
        if ($edit && $request->input('image')) {
            ...
            $this->deleteOldFile(companyPath().'/departments/'.$oldFile['image']);
        }

        //Uploading new file
        $fileUpload = $this->uploadPublicFile(
            $request, 'image', companyPath().'/departments/', 
