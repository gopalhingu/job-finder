function Candidate() {
    ...
    this.initCandidatesDatatable = function () {
        $('#candidates_datatable').DataTable({
            ...
            "ajax": {
                "type": "POST",
                "url": application.url+'/employer/matched-candidates/data',
                "data": function ( d ) {
    ...
    this.initSendMail = function () {
        ...
        $('.send-mail').on('click', function () {
            ...
            application.load('/employer/candidates/send-mail/'+id+'/'+job_id, '', function (result) {
